...
import { SettingsToggle, SettingsModal } from "./Settings";
...
const Create = ({ polls, setPolls }) => {
  ...
  const disabled =
    title.length < 20 || options.length < 2 || category.name === "category";
